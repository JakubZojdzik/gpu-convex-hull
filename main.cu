...
///////
extern void cpuMonotoneChain(float *p_x, float *p_y, int N, float *result_x,
                             float *result_y, int *M);

extern "C" void gpuQuickHull(float *p_x, float *p_y, int N, float *result_x,
                             float *result_y, int *M);

extern "C" void gpuQuickHullNaive(float *p_x, float *p_y, int N,
...
__global__ void generate_points(float *px, float *py, int N,
...
int main() {
  ...
  visualizeConvexHull(h_px, h_py, N, result_x, result_y, M_gpu, "results.ppm",
                      1028, 1028);
